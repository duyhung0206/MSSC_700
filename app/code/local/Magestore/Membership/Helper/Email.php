...
class Magestore_Membership_Helper_Email extends Mage_Core_Helper_Abstract
{
	...
	const XML_PATH_NOTIFY_AUTO_RENEW_PACKAGE_EMAIL = 'membership/general/notify_auto_renew_package_email_template';
	...
	public function sendEmailNotifyAutoRenewPackage($memberPackage){
		$translate = Mage::getSingleton('core/translate');
        $translate->setTranslateInline(false);
		$template = Mage::getStoreConfig(self::XML_PATH_NOTIFY_AUTO_RENEW_PACKAGE_EMAIL);
